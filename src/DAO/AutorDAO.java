...
public class AutorDAO {
    ...
    ArrayList<AutorDTO> lista = new ArrayList<>();// uma arraylist é criada para receber os dados digitados
    ...
    public void cadastrarAutor(AutorDTO objautordto) throws SQLException{
        ...
        try {
            ...
            pstm.setString(1,objautordto.getNome_autor());
            pstm.setString(2,objautordto.getSobrenome_autor());
            ...
            JOptionPane.showMessageDialog(null, "Erro no Cadastro do autor" + e);
        }finally{
            pstm.close();
        }
    ...
    // metodo criado para executar a função de listagem de autores  por meio de uma pesquisa no banco na tabela autor
    public ArrayList<AutorDTO> listarAutor() throws SQLException{
        ...
        try {
            ...
            while (rs.next()) {// o laço while se mantem  varrendo o resulset e em seguida cada registro encontrado e setado no objeto DTO para transferencias de objetos
                ...
                objautordto.setId_autor(rs.getInt("id"));
                objautordto.setNome_autor(rs.getString("nome"));
                objautordto.setSobrenome_autor(rs.getString("sobrenome"));
                
                lista.add(objautordto);
            }

        } catch (SQLException erro) {
            JOptionPane.showMessageDialog(null, "AutorDAO Pesquisar" + erro);
        }finally{
   ...
   /*metodo para realizar pesquisas ao digitar no campo de texto possui 2 parametros , um para receber a instrução sql em string e outro para receber a tabela da tela onde
    ...
    public void pesquisaAutor(String sql,JTable tabela) throws SQLException{
    ...
    public void alterar(JTextField camponome,JTextField camposobrenome,JTextField campoid) throws SQLException{
        // uma string para dar a instrução sql ao banco  nesse caso uma instrução para atualizar colunas em uma coluna especifica onde o id for igual ao digitado pelo usuario
         ...
         try {
             ...
             pstm.setString(2,camposobrenome.getText());
             pstm.setString(3,campoid.getText());
    ...
    public void consultar(JTextField campobusca,JTextField camponome,JTextField camposobrenome) throws SQLException{
        ...
        try {
           ...
           rs=pstm.executeQuery();
            if (rs.next()) { // o result set é consultado ate o ultimo campo e recebe os valores armazenados no banco
                ...
                camposobrenome.setText(rs.getString(3));
                ...
                JOptionPane.showMessageDialog(null, "Autor não cadastrado");
    ...
    public void excluirAutor(AutorDTO objautor) throws SQLException{ //o metodo recebe como parametro o objeto dto do autor 
        ...
        try {
          ...
          pstm.setInt(1, objautor.getId_autor()); 
